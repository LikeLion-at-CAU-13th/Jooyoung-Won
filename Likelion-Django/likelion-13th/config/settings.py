...
ALLOWED_HOSTS = ['*']   # 모든 호스트(IP)의 요청 허용
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', # 반드시 가장 위쪽에 추가. 가장 먼저 실행되어야 함. (순차적 실행)
...
# TIME_ZONE = 'UTC'
TIME_ZONE = 'Asia/Seoul' # 한국 시간에 맞추기 위해 timezone 변경
...
###S3###
AWS_STORAGE_BUCKET_NAME = 'likelion13th-won'
